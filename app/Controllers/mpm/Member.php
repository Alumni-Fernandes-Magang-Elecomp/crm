...
class Member extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user/mpm/member/create', $data);
    }
    ...
    public function edit_member($id_member)
    {
        ...
        return view('user/mpm/member/edit_member', $data);
    }
    ...
    public function update_member()
    {
        ...
        return redirect()->to('user/mpm/member/list')->with('success', 'Data member berhasil diupdate.');
    }
