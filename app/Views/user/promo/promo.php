                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Promo : <?= $judul_promo->judul_promo; ?></h4>
                            </div>
                        </div>
                        <?php foreach ($artikel_promo as $row) :  ?>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    <div class="d-flex align-items-center">
                                        <!-- <img class="rounded-circle mr-2" src="<?= base_url('assets-baru') ?>/img/promo1.png" width="25" height="25" alt=""> -->
                                        <small><?= $row['judul_promo']; ?></small>
                                    </div>
                                    <div class="d-flex align-items-center">
