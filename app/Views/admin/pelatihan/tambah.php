        ...
        <div class="card-body">
            <form action="/admin/pelatihan/proses_tambah" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->hasError('nama_pelatihan')) ? 'is-invalid' : ''; ?>" id="nama_pelatihan" name="nama_pelatihan" value="<?= old('nama_pelatihan'); ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tgl_akhir')) ? 'is-invalid' : ''; ?>" id="tgl_akhir" name="tgl_akhir" value="<?= old('tgl_akhir'); ?>">
                        <div class="invalid-feedback">
